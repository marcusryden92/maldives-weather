...
const resorts = [
  {
    ...
    description: "Experience luxury overwater villas with stunning sunset views",
    ...
    <div className="space-y-8 px-4 py-12 max-w-7xl mx-auto">
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Discover our carefully curated selection of luxury resorts, perfectly matched to each season's weather patterns
        </p>
      </div>
          ...
          >
            <div className="aspect-video relative overflow-hidden">
              ...
              <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                <span className="text-accent font-semibold">★ {resort.rating}</span>
              </div>
            </div>
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <CardDescription className="mt-2">{resort.description}</CardDescription>
                </div>
                <span className="font-semibold text-accent whitespace-nowrap">{resort.price}</span>
              </div>
            </CardHeader>
